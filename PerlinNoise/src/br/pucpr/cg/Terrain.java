...
public class Terrain implements Scene {
    ...
    public void init() {
        ...
        try {
            mesh = MeshFactory.loadTerrain(new File("C:/Users/Lukas/Documents/Prog3D/img/terrain/island.png"), 0.5f);
...
public void draw() {
    ...
    public static void main(String[] args) {
        new Window(new Terrain(), "Terreno cinza com luz", 1024, 768).show();
    }
}
